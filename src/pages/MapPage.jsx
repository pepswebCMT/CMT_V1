...
const MyMap = () => {
  ...
  useEffect(() => {
    ...
    const locationCheckInterval = setInterval(handleLocationPermission, 5000); // Vérifie toutes les 5 secondes

    return () => clearInterval(locationCheckInterval); // Nettoie l'intervalle lors du démontage
  }, []);
